...
pub struct Config {
    ...
    /// Base URL of the srvcs-root dependency.
    pub root_url: String,
}
...
impl Config {
    pub fn from_vars(
        ...
        Config {
            ...
            root_url: root_url.unwrap_or_else(|| "http://127.0.0.1:8120".to_string()),
        }
    }
...
mod tests {
    ...
    fn defaults_are_sane() {
        ...
        assert_eq!(c.root_url, "http://127.0.0.1:8120");
    }
